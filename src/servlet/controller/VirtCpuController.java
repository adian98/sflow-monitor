...
import counter_record.VirtCpuInfo;
...
public class VirtCpuController extends AbstractController {
    public VirtCpuController(Object params, String id) {
        super(params, id);
    }
    ...
    protected Result doHandle(HttpServletRequest req, HttpServletResponse resp) throws Exception {
        ...
        List<HashMap> list = VirtCpuInfo.fromDb(hostname, timestamp);
