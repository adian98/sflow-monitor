...
public class VirtDiskController extends AbstractController {
    public VirtDiskController(Object params, String id) {
        super(params, id);
    }
    ...
    protected Result doHandle(HttpServletRequest req, HttpServletResponse resp) throws Exception {
        ...
        List<HashMap> list = VirtDiskIoInfo.fromDb(hostname, timestamp);
