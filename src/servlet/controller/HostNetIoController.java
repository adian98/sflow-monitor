...
import counter_record.HostNetIoInfo;
...
public class HostNetIoController extends AbstractController {
    public HostNetIoController(Object params, String id) {
        super(params, id);
    }
    ...
    protected Result doHandle(HttpServletRequest req, HttpServletResponse resp) throws Exception {
        ...
        List<HashMap> list = HostNetIoInfo.fromDb(host_ip, timestamp);
